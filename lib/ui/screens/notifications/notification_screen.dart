...
class _NotoficationScreenState extends State<NotoficationScreen> {
  ...
  final List _text = ['3 Schedules!' ,'14 Messages' , 'Medicine' , 'Vaccine Update', 'App Update'];
   final List _image = [
    Image.asset(AssetsManager.scheduleimage,color: Color(0xff1C6BA4),),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children:  [
                              ...
                              fontWeight: FontWeight.w700,
                              fontFamily: 'NunitoSans'),),
                              Text('Check your schedule Today',
                          style: TextStyle(
